...
size_t FrameManager::AddFrameBuffer(size_t width, size_t height)
{
	...
	glGenTextures(1, &frameRenderBuffer.texture2Id);
	glBindTexture(GL_TEXTURE_2D, frameRenderBuffer.texture2Id);
	...
	glFramebufferTexture2D(GL_FRAMEBUFFER, (GLenum)ColorBuffer::COLOR_2, GL_TEXTURE_2D, frameRenderBuffer.texture2Id, 0);
	...
	default:
		...
		glDeleteTextures(1, &frameRenderBuffer.texture2Id);
...
void FrameManager::DeleteFrameBuffer(FrameRenderBuffer& frameBufferRecord)
{
	...
	frameBufferRecord.texture2Id = 0;
