...
protected:
	...
	RandomValueAtTimeline<Vector4fWrapper, RandomVector4f> spawnRange;
	...
	RandomValueAtTimeline<Vector3fWrapper, RandomVector3f> rotation;
...
protected:
	...
	std::shared_ptr<Interpolator<Vector4fWrapper>> spawnRange;
...
protected:
	...
	std::shared_ptr<Interpolator<Vector3fWrapper>> rotation;
