#ifndef LIVECAM_OPENGL_SHADER_H
#define LIVECAM_OPENGL_SHADER_H
...
#define GL_PARSE_SHADER(version, shader)  "#version " #version "\n" #shader
...
namespace gl {
  ...
  inline void Shader::use() {
    if(!prog) {
      LC_ERROR(ERR_GL_SH_NOT_CREATED);
      return;
    }
