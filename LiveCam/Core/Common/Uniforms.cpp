...
{
	usedShader->setUniform1i(const_cast<char*>(uniformName.c_str()), i);
}

void ObjectRenderParamVisitor_GLSetter::operator()(TUniform1f f) const
{
	usedShader->setUniform1f(const_cast<char*>(uniformName.c_str()), f);
}

void ObjectRenderParamVisitor_GLSetter::operator()(TUniform2f f2) const
{
	usedShader->setUniform2fv(const_cast<char*>(uniformName.c_str()), 1, f2.data());
}

void ObjectRenderParamVisitor_GLSetter::operator()(TUniform3f f3) const
{
	usedShader->setUniform3fv(const_cast<char*>(uniformName.c_str()), 1, f3.data());
}

void ObjectRenderParamVisitor_GLSetter::operator()(TUniform4f f4) const
{
	usedShader->setUniform4fv(const_cast<char*>(uniformName.c_str()), 1, f4.data());
}

void ObjectRenderParamVisitor_GLSetter::operator()(TUniform16 M16) const
{
	usedShader->setUniformMatrix4fv(const_cast<char*>(uniformName.c_str()), 1, false, M16.data());
}
