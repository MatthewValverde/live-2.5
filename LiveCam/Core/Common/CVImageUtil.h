...
public:
	...
	static FaceContours extractFaceContourInFrame(TrackingTarget& face);
	...
	static FaceLightParams getFaceLightParams(cv::Mat& frame, FaceContours& contours, TrackingTarget& face);
};
