...
namespace fbx_loader {
	...
	public:
		...
		bool LoadFile(std::vector<shape_fbx> *shapes);

		void CollectMeshes(shape_fbx *shape, FbxScene * pScene);
	...
	// Save mesh vertices, normals, UVs and indices in GPU with Graphics Vertex Buffer Objects
	class VBOMesh
	{
	public:
		VBOMesh();
