#include "FxWidgetFaceDistortion.h"
...
void GraphicsFaceDistortionModel::transform(TrackingTarget& face, ExternalRenderParams &externalRenderParams)
{
	...
	double faceWidth = planeW * widthRawSmooth / Resolutions::OUTPUT_WIDTH;
...
void GraphicsFaceDistortionModel::draw(TrackingTarget& face, ExternalRenderParams &externalRenderParams)
{
