...
void EmojiModelTab::readEmojiModelProperties(FX* sourceFilter, FxWidget2D* model, boost::property_tree::ptree& suit, fs::path& resourcesRoot)
{
...
void EmojiModelTab::on_shiftX_slider_valueChanged(int value)
{
	...
	auto curOffset = ((FxWidget2D*)editorWindow->editableFilter->models[curModelIndex].get())->emojisOffset[0];
...
void EmojiModelTab::on_scaleX_slider_valueChanged(int value)
{
	...
	auto curScale = ((FxWidget2D*)editorWindow->editableFilter->models[curModelIndex].get())->emojisScale[0];
