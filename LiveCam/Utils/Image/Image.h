#ifndef LIVECAM_IMAGE_IMAGE_H
#define LIVECAM_IMAGE_IMAGE_H
...
bool lc_load_png(Image& img, std::string filename, bool datapath = false);
bool lc_load_jpg(Image& img, std::string filename, bool datapath = false);
bool lc_load_tga(Image& img, std::string filename, bool datapath = false);

bool lc_save_png(Image& img, std::string filename, bool datapath = false);
