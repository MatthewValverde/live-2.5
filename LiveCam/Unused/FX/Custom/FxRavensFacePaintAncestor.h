...
#include <models/GraphicsModel.h>
...
protected:
	...
	std::array<std::array<ValueSmoother, 66 * 2>, ObjectTracker::MAX_TO_TRACK> facePointsSmoothers;
...
class RavensFacePaintModel : public GraphicsModel
{
public:
	RavensHalfFacePaint halfFacePaint;
	std::array<RavensHalfFaceParams, ObjectTracker::MAX_TO_TRACK> halfFaceParams;
